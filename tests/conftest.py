...
from docent.domain.models import InputField, ModelSchema, OutputField, ScenarioDefinition
...
@pytest.fixture
def simple_model():
    """A trivial model function: value = 100 - (rate - 5) * 6.5"""
...
@pytest.fixture
def service(schema, scenarios, simple_model) -> PortfolioService:
